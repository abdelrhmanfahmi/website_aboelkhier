...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css">
    ...
    <div class="edit-recieved-reset">
        ...
        <form id="submitRecieveResetRevise" enctype="multipart/form-data">
            @csrf
            {{ method_field('PUT') }}
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 mb-3">
                    <label><span class="text-danger">*</span>مسؤول التعديل</label>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label>فوري</label>
                    <input type="checkbox" name="nowsRushed" id="nows" {{ $recieved_reset->money_status == '0' ? 'checked' : '' }}>

                    &nbsp;

                    <label>مستعجل</label>
                    <input type="checkbox" name="nowsRushed" id="rushed" {{ $recieved_reset->money_status == '1' ? 'checked' : '' }}>
                </div>
                <div class="col-md-6">
                    <label>هل تريد عمل كوبي لملفات الشخص؟</label>
                    <input type="checkbox" name="copies" id="copies" {{ count($resetFilesCopies) > 0 ? 'checked' : '' }}>
                </div>
            </div>
                    ...
                    @foreach ($resetFilesCopies as $index => $resetFileCopy)
                        <div id="row" class="row">
                            <div class="col-md-5 mb-3">
                                ...
                                <input class="form-control fileNamesCopies" value="{{ $resetFileCopy->reset_file_copy_name }}"/>
                            </div>
                            <div class="col-md-5 mb-3">
                                <label><span class="text-danger">*</span>عدد النسخ</label>
                                <input type="number" readonly class="form-control fileNumberCopies" value="{{ $resetFileCopy->number_copies }}"/>
                            </div>
                            @if($index == 0)
                                <div class="col-md-2 mb-3 d-flex align-items-center">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" name="reset_cost_paid" id="reset_cost_paid" value="{{ $recieved_reset->reset_cost_paid }}" class="form-control" disabled>
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <input type="checkbox" {{ $recieved_reset->has_discount == '1' ? 'checked' : ''}} name="has_discount" id="discount">
                </div>
            </div>
                ...
                <div class="row mb-3 ifDiscount">
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" name="discount_price" value="{{ $recieved_reset->discount_price }}" id="discount_price" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label>وصف الخصم</label>
                        <input type="text" name="discount_desc" value="{{ $recieved_reset->discount_desc }}" id="discount_desc" class="form-control">
                    </div>
                </div>
            @else
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#printReset').on('click' , function(e){
                window.location.href = '/resets/'+id+'/printRevision';
            });

            $('#printResetForSystem').on('click' , function(e){
                window.location.href = '/resets/'+id+'/printRevisionForSystem';
            });

            $('#printResetTwo').on('click' , function(e){
                window.location.href = '/reset/check/payed/revision/'+id;
            });

            $('#submitRecieveResetRevise').on('submit' , function(e){
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success:function(res){
                        ...
                        if(res == 1){
                            ...
                            setTimeout(() => {
                                window.location.href = '/revisions/resets';
                            }, 1500);
                        }else{
            ...
            $('#revertToSecratary').on('click' , function(e){
                ...
                $.ajax({
                    ...
                    success:function(res){
                        ...
                        if(res == 1){
                            unloading();
                            toastr.success('الفاتورة تم استرجاعها للسكارتارية بسبب خطأ ما');
                            setTimeout(() => {
                                window.location.href = '/revisions/resets';
                            }, 1500);
                        }else{
