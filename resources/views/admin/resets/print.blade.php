...
<head>
    ...
    <style>
        .bg-image{
            background-image: url("../../../../assets/images/firstLogo.JPG");
        }
        .page-header{
            position: relative;
            bottom: 0;
        ...
        <div >
            <div class="row">
                <div class="col-md-12 mb-3 text-center">
                    <h3>إيصال استلام للعميل فاتورة ترجمة رقم <span style="font-weight:bold;font-size:36px;">{{ $printedReset->id }}</span></h3>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <label style="font-weight:bold;font-size:24px;">الجهة</label>
