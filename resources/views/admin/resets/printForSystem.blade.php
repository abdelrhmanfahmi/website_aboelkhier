...
<body>
        ...
        <div >
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <textarea cols="30" rows="5" class="form-control" style="font-weight:bold;font-size:24px;" disabled>{{ $printedReset->reset_where }}</textarea>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                @else
                    <div class="col-md-12">
                        <label style="font-weight:bold">متسلم الاوراق</label>
            ...
            <div class="row">
                <label style="font-weight:bold">نوع الفاتورة</label>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label style="font-weight:bold;font-size:24px">ملاحظات للعميل</label>
                ...
                <div class="col-md-6">
                    <label style="font-weight:bold;font-size:24px">ملاحظات الفاتورة</label>
            ...
            <div class="row">
                <div class="col-md-12">
                    <label style="font-weight:bold;font-size:24px">ملاحظات للمترجمين</label>
    ...
    <div class="d-flex justify-content-center mb-3">
        <a href="{{ route('resets.index') }}" class="btn btn-primary">رجوع</a>
    </div>
